    ...
    render() {
        ...
        return (
            <div className="login-container" >
                ...
                <Form error onSubmit={this.handleSubmit} style={{maxWidth: "50%", margin: "auto", marginTop: "50px", marginBottom: "50px", padding: "20px", border: "5px inset red", backgroundColor: "PowderBlue"}}>
